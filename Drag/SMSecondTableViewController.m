...
#import "SMSecondTableViewController.h"
#import "SMSlideGestureRecognizer.h"

@interface SMSecondTableViewController ()
@property (strong, nonatomic) NSArray* model;
@end

@implementation SMSecondTableViewController
...
-(void)sliderHandler:(NSUInteger)buttonIndex {
